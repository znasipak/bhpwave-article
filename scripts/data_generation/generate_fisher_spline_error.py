...
# user specifies which [M, a] combination they want from 1 to 24
...
data_path = "../../data/'saved_phase_analysis.pkl'"
...
traj=TrajectoryData(file_path=os.path.abspath("../tests/saved_phase_analysis.txt"))
...
M, mu, a = Mmua_dict[analysis_number]
